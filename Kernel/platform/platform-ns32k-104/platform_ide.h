...
#define IDE_REG_DATA		0x00FEC000
#define IDE_REG_ERROR		0x00FEC004
#define IDE_REG_FEATURES	0x00FEC004
#define IDE_REG_SEC_COUNT	0x00FEC008
#define IDE_REG_LBA_0		0x00FEC00C
#define IDE_REG_LBA_1		0x00FEC010
#define IDE_REG_LBA_2		0x00FEC014
#define IDE_REG_LBA_3		0x00FEC018
#define IDE_REG_DEVHEAD		0x00FEC018
#define IDE_REG_STATUS		0x00FEC01C
#define IDE_REG_COMMAND		0x00FEC01C
...
#define PPIDE_BASE      0xFE8000     /* Base address of 8255A */
#define PPIDE_PORTA     0x00
#define PPIDE_PORTB     0x04
#define PPIDE_PORTC     0x08
#define PPIDE_CONTROL   0x0C
...
#define PPIDE_A1_LINE           0x08 /* Direct from 8255 to IDE interface */
#define PPIDE_A2_LINE           0x80 /* Direct from 8255 to IDE interface */
#define PPIDE_CS0_LINE          0x20 /* Inverter between 8255 and IDE interface */
#define PPIDE_CS1_LINE          0x40 /* Inverter between 8255 and IDE interface */
#define PPIDE_WR_LINE           0x02 /* Inverter between 8255 and IDE interface */
#define PPIDE_WR_BIT            1    /* (1 << PPIDE_WR_BIT) = PPIDE_WR_LINE */
#define PPIDE_RD_LINE           0x04 /* Inverter between 8255 and IDE interface */
#define PPIDE_RD_BIT            2    /* (1 << PPIDE_RD_BIT) = PPIDE_RD_LINE */
#define PPIDE_RST_LINE          0x01 /* Inverter between 8255 and IDE interface */

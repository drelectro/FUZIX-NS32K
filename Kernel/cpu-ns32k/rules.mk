...
export CROSS_CCOPTS=-c -Os -fno-strict-aliasing -fomit-frame-pointer -fno-builtin -m32032 -m32081 -Wall -I$(ROOT_DIR)/cpu-ns32k -I$(ROOT_DIR)/platform/platform-$(TARGET) -I$(ROOT_DIR)/include
#export CROSS_CCOPTS=-c -Os -fno-strict-aliasing -fomit-frame-pointer -fno-builtin -m32032 -msoft-float -Wall -I$(ROOT_DIR)/cpu-ns32k -I$(ROOT_DIR)/platform/platform-$(TARGET) -I$(ROOT_DIR)/include
